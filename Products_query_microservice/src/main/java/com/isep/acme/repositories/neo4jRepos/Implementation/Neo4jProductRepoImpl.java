...
public class Neo4jProductRepoImpl implements ProductServiceRepo {
    ...
    public Iterable<Product> getCatalog() {
        ...
        System.out.println("Getting catalog" + product.size());
        List<Product> products = new ArrayList<>();
    ...
    public Product save(Product product) {
        ...
        Neo4jProduct neo4jProduct = new Neo4jProduct(sku, product.getDesignation(), product.getDescription(), product.isPublished());
